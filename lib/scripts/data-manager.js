...
function initializeMapPositionEditor(building) {
    ...
    // Add click handler for the map container
    mapContainer.addEventListener('click', function(e) {
        if (e.target === dot) return; // Ignore clicks on the dot itself
    ...
    xInput.addEventListener('change', updateFromInputs);
    yInput.addEventListener('change', updateFromInputs);
